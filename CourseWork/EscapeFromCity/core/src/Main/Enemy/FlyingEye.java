...
public class FlyingEye extends Actor {
    ...
    public void create() {
        ...
        _currentAnimation = util.CreateAnimation(Gdx.files.internal(basePath+"Flight.png"),4,1,0.13f);
        animations.put(AnimMap.Idle,_currentAnimation);
        animations.put(AnimMap.Move, util.CreateAnimation(Gdx.files.internal(basePath+"Flight.png"),8,1,0.04f));
