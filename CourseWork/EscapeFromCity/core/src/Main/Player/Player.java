...
public class Player extends Actor {
    ...
    public void create() {
        ...
        _currentAnimation = util.CreateAnimation(Gdx.files.internal(basePath+"Idle.png"),4,1,0.1f);
        animations.put(AnimMap.Idle,_currentAnimation);
        animations.put(AnimMap.Move, util.CreateAnimation(Gdx.files.internal(basePath+"Walk.png"),4,1,0.1f));
